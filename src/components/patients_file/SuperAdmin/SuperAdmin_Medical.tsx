...
import { collection, query, onSnapshot, where, doc, getDoc, orderBy, writeBatch, deleteDoc, updateDoc } from "firebase/firestore";
    ...
    <div className="dashboard">
      ...
      <main className="main-content-superadmin">
        ...
        <div className="top-navbar-superadmin">
          <h5 className="navbar-title">Medical Appointments</h5>
