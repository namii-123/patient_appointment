...
import { collection, query, onSnapshot, where, doc, getDoc, deleteDoc, updateDoc, writeBatch, orderBy } from "firebase/firestore";
...
>
  ...
  <p>All</p>
          ...
          <div
            className={`summary-cardsss cancelled ${filter === "cancelled" ? "active" : ""}`}
