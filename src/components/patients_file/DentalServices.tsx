...
import "../../assets/DentalServices.css";
...
const DentalServices: React.FC<DentalServicesProps> = ({ onNavigate, patientId, controlNo, formData }) => {
  ...
  try {
    ...
    console.log("✅ Dental appointment saved:", docRef.id);
