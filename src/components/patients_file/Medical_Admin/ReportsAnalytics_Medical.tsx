...
const ReportsAnalytics_Medical: React.FC = () => {
...
const templatePage = copiedPages[0]; 
      ...
      drawCentered("MEDICAL REPORTS", y, 18, true);
      y -= 30;
...
const safeBuffer = uint8.buffer.slice(0); 
  ...
  const filename = `Medical_Report_${year || "All"}_${month || "All"}_${status}_${new Date().toISOString().slice(0,10)}.pdf`;
...
const handleDownloadPDFReport = async () => {
  ...
  input.onchange = async () => {
    ...
    try {
      ...
      drawCenteredText("MEDICAL REPORTS", y, 18, true);
      y -= 30;
      ...
      const filename = `Medical_Report_${year || "AllTime"}_${month || "All"}_${status}_${new Date().toISOString().slice(0,10)}.pdf`;
        ...
        <div>
          ...
          <nav className="nav-linkss">
            ...
            <div className="nav-item">
              ...
              <span onClick={() => navigate("/manageslots_medical")}>
                Manage Slots
              </span>
            </div>
             <div className="nav-item">
...
export default ReportsAnalytics_Medical;
