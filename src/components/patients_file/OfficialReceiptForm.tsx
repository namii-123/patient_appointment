...
interface OfficialReceiptFormProps {
  onNavigate?: (
    targetView:
      | "validid"
      | "confirm"
...
const OfficialReceiptForm: React.FC<OfficialReceiptFormProps> = ({
  onNavigate,
  patientId,
  controlNo,
  formData,
  ...
  useEffect(() => {
    ...
    if (formData) {
      console.log("📌 FormData from Previous Step:", formData);
    }
  }, [patientId, formData]);
  ...
  return (
    <div className="courtorder p-6">
      <h2 className="text-2xl font-bold mb-4">Official Receipt Upload/Charge TO  MAIP (Medical Assistance for Indigent Patients)</h2>
      ...
      <form className="space-y-6">
        <div className="mt-6">
          ...
          <p className="note-message mb-2">
            ...
            documentation purposes. You may proceed without uploading.
          </p>
          <input
            type="file"
