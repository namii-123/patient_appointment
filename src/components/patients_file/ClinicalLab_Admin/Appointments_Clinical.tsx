...
import { FaBell, FaUser, FaTachometerAlt, FaCalendarAlt, FaUsers, FaChartBar, FaSignOutAlt, FaSearch, FaSpinner, FaClock } from "react-icons/fa";
import "../../../assets/Appointments_Clinical.css";
import logo from "/logo.png";
import { db } from "../firebase";
import { sendEmail } from "../emailService";
import { collection, getDocs, doc, getDoc, updateDoc,   query, onSnapshot,
        ...
        <div>
          ...
          <nav className="nav-linkss">
            ...
            <div className="nav-item">
              ...
              <span
                onClick={() => handleNavigation("/reports&analytics_clinical")}
              >
                Reports & Analytics
              </span>
            </div>
                ...
                <div className="modal-contentss">
                  <table className="info-table">
                    <tbody>
                      ...
                      <tr><th>Services</th><td>{selectedPatient.services}</td></tr>
