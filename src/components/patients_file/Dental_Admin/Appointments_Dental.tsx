  ...
  try {
    ...
    if (slotSnap.empty) {
      ...
      timesToBook.forEach(time => {
        const slotRef = doc(collection(db, "Slots_Dental"));
        batch.set(slotRef, {
          date: rescheduleDate,
          time: time,
          isBooked: true,
    ...
    const message = `Your appointment has been RESCHEDULED by the Dental Department.\n\nNew Schedule:\nDate: ${rescheduleDate}\nTime: ${start12} - ${endTimeDisplay} (2-hour block)\n\nPlease arrive on time.\n\nThank you!\nDental Team`;
